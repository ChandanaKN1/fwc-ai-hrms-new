...
export default function HRDashboard() {
  ...
  const features = [
    ...
    { 
      ...
      color: "yellow", 
      // 🟢 FIXED HERE: navigate to your existing route
    ...
    { 
      ...
      description: "Manage employee profiles and structure.", 
    ...
    { 
      title: "Projects", 
      description: "Add and track employee projects.", 
    ...
    { 
      title: "Feedback", 
      description: "View anonymous employee feedback.", 
